...
<?php
    ...
    $address_country = 'TH';//isset( $profile_info['address']['country'] ) ? $profile_info['address']['country'] : '';
    ...
    if ( is_wp_error( $validate ) ) {
        ...
        $address_country = 'TH';//$posted_address['country'];
...
<?php do_action( 'dokan_settings_before_form', $current_user, $profile_info ); ?>
    ...
    <form method="post" id="store-form"  action="" class="dokan-form-horizontal">
        ...
        <?php endif; ?>
		<!-- Pare Add Original Google Map Registration Form -->
<div class="dokan-form-group">
        ...
        </div> <!-- .dokan-form-group --><!-- End Pare Add Google Map Original Registration Form -->
        <?php do_action( 'dokan_settings_form_bottom', $current_user, $profile_info ); ?>
  <!-- Add WP user frontend submission form to update -->
...
<!-- Pare Add Custom Registration Form -->
 <div style="width: 100%">
		<?php echo do_shortcode('[wpuf_profile type="profile" id="360"]'); ?>
         </div>
